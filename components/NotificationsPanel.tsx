...
import { AlertCircle, BellRing, ListChecks, Send, Sparkles, CalendarDays, Clock, CheckCircle2, Check, Hourglass } from 'lucide-react';
...
export const NotificationsPanel: React.FC<NotificationsPanelProps> = ({ 
  ...
  // Change visibility to hidden lg:flex (hidden on md) to prevent layout squashing
  return (
    <>
    <div className="w-80 bg-white h-screen flex flex-col border-r border-gray-200 shadow-sm hidden lg:flex font-sans shrink-0">
      ...
      <div className="flex-1 overflow-y-auto p-5 space-y-6 custom-scrollbar bg-gray-50/30">
        ...
        {/* Section 1: Today's Schedule (BOLD GREEN) */}
        <div>
        ...
        {/* Section 2: "Soon" - CHANGED TO ORANGE */}
        <div>
        ...
        {/* Section 3: "Late" - (RED - No Change needed) */}
        <div>
          <div className="flex items-center justify-between mb-1 pt-4 border-t border-gray-200">
            <div className="flex items-center gap-2">
