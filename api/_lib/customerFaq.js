...
const buildBreedPriceReply = (breedKey) => {
  switch (breedKey) {
    case 'toy_poodle':
      return (
        'עלות תספורת טוי פודל מתחילה מ-240 ש"ח. המחיר יכול להשתנות בהתאם למצב הפרווה (קשרים) והתנהגות הכלב.\n' +
        '\n' +
        'הטיפול כולל:\n' +
        '- ציפורניים\n' +
    ...
    case 'shih_tzu':
      return (
        'עלות תספורת שיצו מתחילה מ-230 ש"ח. המחיר יכול להשתנות בהתאם למצב הפרווה והתנהגות הכלב.\n' +
        '\n' +
        'הטיפול כולל:\n' +
        '- ציפורניים\n' +
        '- מריטת שיערות אוזניים\n' +
    ...
    case 'yorkshire':
      return (
        'עלות תספורת יורקשייר מתחילה מ-230 ש"ח. המחיר יכול להשתנות בהתאם להתנהגות הכלב ולמצב הפרווה (קשרים).\n' +
        '\n' +
        'הטיפול כולל:\n' +
        '- ציפורניים\n' +
        '- ניקוי אוזניים\n' +
    ...
    case 'pomeranian':
      return (
        'עלות טיפוח פומרניין / פום מתחילה מ-240 ש"ח. המחיר יכול להשתנות בהתאם למצב הפרווה והתנהגות הכלב.\n' +
        '\n' +
        'הטיפול כולל:\n' +
        '- ציפורניים\n' +
        '- ניקוי אוזניים\n' +
        ...
        '- עבודת מספריים\n' +
        '\n' +
        'כדי לדייק: מתי היה הטיפוח/תספורת האחרונים ובת כמה היא?'
      );
    case 'maltipoo':
      return (
        'עלות תספורת מלטיפו מתחילה מ-240 ש"ח. המחיר יכול להשתנות בהתאם למצב הפרווה והתנהגות הכלב.\n' +
        '\n' +
        'הטיפול כולל:\n' +
        '- ציפורניים\n' +
        '- מריטת שיערות אוזניים\n' +
    ...
    case 'maltese':
      return (
        'עלות תספורת מלטז מתחילה מ-230 ש"ח. המחיר יכול להשתנות בהתאם למצב הפרווה (קשרים) והתנהגות הכלב.\n' +
        '\n' +
        'הטיפול כולל:\n' +
        '- ציפורניים\n' +
        '- מריטת שיערות אוזניים\n' +
